...
/opt/letsencrypt/letsencrypt-auto certonly -a webroot --webroot-path=/usr/share/nginx/html -d benson.fi -d www.benson.fi --register-unsafely-without-email --agree
